...
AS $function$
BEGIN
    -- 1.0 Limpeza de conflitos de origem antes de tentar atualizar
    -- Se um registro 'particular' está vinculado a um agendamento de convênio, 
    -- e já existe o mesmo registro como 'convenio' na faturamento, removemos o duplicado 'particular'.
