...
DROP POLICY IF EXISTS "Allow authenticated full access to lab_dim_categoria" ON public.lab_dim_categoria;
...
DROP POLICY IF EXISTS "Allow authenticated full access to lab_dim_centro_custo" ON public.lab_dim_centro_custo;
